...
author: <font size='8'>team <br> Felix, Jeni, ____</font>
...
1.  What are the factors that can affect the average ticket price of a show? 
2. **Hence, how does average ticket price then influence the weekly gross revenue earned?**
...
## MUTATE Theatre Size
```{r mutate-theatre-size, message = FALSE, warning = FALSE}
...
## Percentage Capacity and Weekly Gross
...
## MAIN QUESTION: Average Price vs Weekly Gross

```{r avg-price-weekly-gross1, message = FALSE, warning = FALSE, echo = FALSE}
grosses %>%
